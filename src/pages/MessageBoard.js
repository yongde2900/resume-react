...
const MessageBoard = (props) => {
  ...
  return (
    <div className="bg-gray-100">
      <div className=" mx-auto p-4 min-h-screen flex flex-col w-2/3  item-center drop-shadow-md">
          ...
          <div key={message.id} className="bg-white p-4 rounded shadow mb-4">
            <div className="flex justify-between mb-2">
              <div className="flex items-center">
                ...
                <span className="text-gray-500 ml-2">{message.updated_at}</span>
                {message.created_at !== message.updated_at ? (
                  <span className="text-gray-400 ml-2 text-xs">已編輯</span>
                ) : null}
              </div>
              <div className="flex items-center">
